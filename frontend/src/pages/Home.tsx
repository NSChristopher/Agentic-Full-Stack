      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Order your favorite food for pickup or delivery. Fast, convenient, and delicious!
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose between convenient pickup or fast delivery to your location.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Quick preparation times and reliable service for your satisfaction.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Our Menu</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Our Service</h4>
              <ul className="space-y-2 text-gray-600">
